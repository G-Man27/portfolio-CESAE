...
public class Carro {
    ...
    public void imprimirCombustivelConsumido(double km){
        double consumo= combustivelConsumido(km);
        System.out.println("O "+this.marca+" "+this.modelo+" consumiu " + consumo+" L nestes "+km+" Km");
    }
    public double combustivelConsumido(double km) {
        double consumo = this.consumo * km / 100;
        return consumo;
    }
}
